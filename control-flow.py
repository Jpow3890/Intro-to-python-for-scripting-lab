...
def weather_advice():
    ...
    if cold == "yes" and rain == "yes":
        print("Wear a weartherproof coat. ")
...
def determine_season():
    ...
    if (month in ["Mar", "Apr" , "May" , "Jun"] and (month == "Mar" and day >= 20) or (month in ["Apr" , "May"]) or (month == "Jun" and day <= 20)):
        season = "Spring"
    # Summer
    if (month in ["Jun" , "July" , "Aug" , "Sept"] and (month == "Jun" and day >= 21) or (month in ["Jul" , "Aug"]) or (month == "Sept" and day <= 21)):
        season = "Summer"    
    # Fall
    if (month in ["Sept" , "Oct" , "Nov" , "Dec"] and (month == "Sept" and day >= 22) or (month in ["Oct" , "Nov"]) or (month == "Dec" and day <= 20)):    
        season = "Fall"
